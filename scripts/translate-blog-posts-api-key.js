...
// Configuración - Reemplaza con tu API Key de Google Cloud
const GOOGLE_TRANSLATE_API_KEY = process.env.GOOGLE_TRANSLATE_API_KEY || '';

if (!GOOGLE_TRANSLATE_API_KEY) {
  console.error('❌ Error: GOOGLE_TRANSLATE_API_KEY no está configurada');
  console.log('\n💡 Para usar este script:');
  console.log('   1. Obtén una API Key de Google Cloud Console');
  console.log('   2. Configura la variable de entorno:');
  console.log('      $env:GOOGLE_TRANSLATE_API_KEY="tu-api-key"');
  console.log('   3. O edita este archivo y reemplaza GOOGLE_TRANSLATE_API_KEY con tu clave\n');
  process.exit(1);
}

// Inicializar Google Cloud Translate con API Key
...
try {
  ...
  console.log('✅ Google Cloud Translate inicializado con API Key');
} catch (error) {
...
async function main() {
  ...
  console.log('\n🚀 Script de Traducción de Posts del Blog (API Key)');
